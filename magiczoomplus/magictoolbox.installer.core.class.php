<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function setBackups() {
            ...
            $this->setError('Installer has modified following OpenCart files:');
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.4.13' || 'working' == 'v5.2.5') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=commercial&tool_version=v5.2.5&module_version=v4.4.13&platform_name=opencart&platform_version={$platformVersion}&url={$url}";
