...
$_['text_weight_eq'] = 'Note: Xshippingpro consider these equations. For Dimensional Weight = (volume / factor) x weight. For Volumetric Weight = volume x factor';

$_['button_save_continue'] = 'Save and Continue';
$_['ignore_modifier'] = 'Ignore/Discard Price Adjustment until <i>Per unit block</i> take into account';
...
$_['text_city_enter_tip']    = 'Multiple cities are available. One city per line';
...
$_['text_coupon_tip']    = 'Multiple Coupon allowed. Comma(,) Separated';
...
$_['tip_additional'] ='If shopping cart value does not fall under any unit ranges, Xshippingpro will calculate shipping cost based on this value by obeying the equation (`Last Price of the unit range` + (`Additional price` * `Last Per Unit Block of the unit range`)). If `Last Per Unit Block` is defined, it would be 1. If you don\'t want to auto calculate, keep it blank OR enter 0';

$_['text_cart_value']    = 'Shopping Cart Modifier';
$_['tip_cart_value'] ='If you want to add/substruct/multiply/divide your shopping cart value before calculating shipping cost, enter the value with arithmetic operator. For example, if you want to add additional 200g packaging weight to the shopping cart weight, enter +200. Or if you want to deduct 200g, you will have to enter -200. Percentage is allowed. e.g +10%';
...
$_['text_method_specific']    = 'Only take the products into account as the per rules defined on Category/Product tab';
...
$_['text_equation_help'] = 'Available parameters {cartTotal}, {cartQnty}, {cartWeight} {shipping}, {modifier}, {volume}, {nofCategory}, {noOfManufacturer}, {noOfLocation}, {couponValue}. Example: {cartTotal}-5*{cartQnty}';
...
$_['text_or_mode_tip']       = 'By default xshippingpro treats all rules as Logical AND operand. If you mark this checkbox, all these rules (product/category/manufacturer/option/location) would be treated as logical OR operand instead of having default AND operand.';
