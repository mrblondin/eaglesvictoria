      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-instagram" class="form-horizontal">
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-10">
              <input type="text" name="access_token" value="<?php echo $access_token; ?>" class="form-control" /><br />
			<a href="https://elfsight.com/blog/2016/05/how-to-get-instagram-access-token/" target="_blank">A guide to receive Account ID and Access Token can be found here</a>
            </div>
          </div>
