...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
    <label><input type="radio" name="settings[basel][salebadge_status]" value="0" <?php if($salebadge_status == '0'){echo ' checked="checked"';} ?> /><span>Disabled</span></label>
    <label><input type="radio" name="settings[basel][salebadge_status]" value="1" <?php if($salebadge_status == '1'){echo ' checked="checked"';} ?> /><span>Enabled</span></label>
    </div>                     
</div>
<div class="form-group">
