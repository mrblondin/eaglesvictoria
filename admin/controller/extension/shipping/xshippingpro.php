<?php
define('XSHIPPINGPRO_VERSION', '2.7.2');
...
class ControllerExtensionShippingXshippingpro extends Controller {
	...
	private function getFormData($data, $new_tab = false)
	{
		...
		foreach($data['method_data'] as $single_method) {
			...
			$return.='</div>'
			.'</div>
			  <div style="'.(($method_data['store_all']!='1')?'display:block':'').'" class="checkbox-selection-wrap"><a href="#" class="check-all">'.$data['check_all'].'</a><a href="#" class="uncheck-all">'.$data['uncheck_all'].'</a></div>'
			.'</div>'
			.'</div>'
			...
			$return.='</div>'
			.'</div>
			  <div style="'.(($method_data['geo_zone_all']!='1')?'display:block':'').'" class="checkbox-selection-wrap"><a href="#" class="check-all">'.$data['check_all'].'</a><a href="#" class="uncheck-all">'.$data['uncheck_all'].'</a></div>'
			.'</div>'
			.'</div>'
			...
			$return.='</div>
			 ...
			 <div style="'.(($method_data['country_all']!='1')?'display:block':'').'" class="checkbox-selection-wrap"><a href="#" class="check-all">'.$data['check_all'].'</a><a href="#" class="uncheck-all">'.$data['uncheck_all'].'</a></div>'
			.'</div>'
			.'</div>'
			...
			$return.='</div>'
			.'</div>
			 <div style="'.(($method_data['customer_group_all']!='1')?'display:block':'').'" class="checkbox-selection-wrap"><a href="#" class="check-all">'.$data['check_all'].'</a><a href="#" class="uncheck-all">'.$data['uncheck_all'].'</a></div>'
			.'</div>'
			.'</div>'

			.'<div class="form-group">'
                .'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="'.$data['text_currency_tip'].'">'.$data['text_currency'].'</span></label>' 
                 .'<div class="col-sm-10">'
		            ...
		            .'<div class="well well-sm" style="height: 100px; overflow: auto;'.(($method_data['currency_all']!='1')?'display:block':'').'">'
		             .'<div class="checkbox xshipping-checkbox">';
			...
			$return.='</div>'
			.'</div>
			  <div style="'.(($method_data['payment_all']!='1')?'display:block':'').'" class="checkbox-selection-wrap"><a href="#" class="check-all">'.$data['check_all'].'</a><a href="#" class="uncheck-all">'.$data['uncheck_all'].'</a></div>'
			.'</div>'
			.'</div>'
			...
			.'</div>'
			.'<div class="form-group">'
            .'<label class="col-sm-2 control-label" for="input-manufacturer_rule'.$no_of_tab.'"><span data-toggle="tooltip" title="'.$data['tip_manufacturer_rule'].'">'.$data['text_manufacturer_rule'].'</span></label>'
            .'<div class="col-sm-10"><select id="input-manufacturer_rule'.$no_of_tab.'" class="form-control selection" rel="manufacturer" name="xshippingpro[manufacturer_rule]">'
            ...
            .'</select></div>'
            .'</div>'
            .'<div class="form-group manufacturer" ' .(($method_data['manufacturer_rule']!=1)?'style="display:block"':'').'>'
            .'<label class="col-sm-2 control-label" for="input-manufacturer'.$no_of_tab.'">'.$data['entry_manufacturer'].'</label>'
            .'<div class="col-sm-10"><input type="text" name="input_manufacturer" value="" placeholder="'.$data['entry_manufacturer'].'" id="input-manufacturer'.$no_of_tab.'" class="form-control" />'
            .'<div class="well well-sm product-manufacturer" style="height: 150px; overflow: auto;">';
            foreach ($method_data['manufacturer'] as $manufacturer_id) {
                $manufacturer_info = $this->model_catalog_manufacturer->getManufacturer($manufacturer_id);
                if($manufacturer_info) {
                    $return.='<div class="product-manufacturer'.$manufacturer_id. '"><i class="fa fa-minus-circle"></i> '.$manufacturer_info['name'].'<input type="hidden" name="xshippingpro[manufacturer][]" value="'.$manufacturer_id.'" /></div>';
                }
            }
            $return.='</div>'
            .'</div>'
            .'</div>'
            .'<div class="form-group">'
            .'<label class="col-sm-2 control-label" for="input-location_rule'.$no_of_tab.'">'.$data['text_location_rule'].'</label>'
            .'<div class="col-sm-10"><select id="input-location_rule'.$no_of_tab.'" class="form-control selection" rel="location" name="xshippingpro[location_rule]">'
            ...
            .'</select></div>'
            .'</div>'
            .'<div class="form-group location" ' .(($method_data['location_rule']!=1)?'style="display:block"':'').'>'
            .'<label class="col-sm-2 control-label" for="input-location'.$no_of_tab.'">'.$data['entry_location'].'</label>'
            .'<div class="col-sm-10"><input type="text" name="input_location" value="" placeholder="'.$data['entry_location'].'" id="input-location'.$no_of_tab.'" class="form-control" />'
            .'<div class="well well-sm product-location" style="height: 150px; overflow: auto;">';
            foreach ($method_data['location'] as $location) {
                if($location) {
                	$id = md5(trim($location));
                    $return.='<div class="product-location'.$id.'"><i class="fa fa-minus-circle"></i> '.$location.'<input type="hidden" name="xshippingpro[location][]" value="'.$location.'" /></div>';
                }
            }
            $return.='</div>'
            .'</div>'
            .'</div>'
            .'<div class="form-group">'
			.'<label class="col-sm-2 control-label" for="input-ignore-rule'.$no_of_tab.'"><input '.(($method_data['ingore_product_rule']=='1')?'checked="checked"':'').' type="checkbox" name="xshippingpro[ingore_product_rule]" value="1" id="input-ignore-rule'.$no_of_tab.'" /></label>'
			.'<div class="col-sm-10"><label style="text-align:left;" class="control-label" for="input-ignore-rule'.$no_of_tab.'"><span data-toggle="tooltip" title="'.$data['text_cat_product_ignore_tip'].'">'.$data['text_cat_product_ignore'].'</span></label></div>'
			.'</div>'
			.'<div class="form-group">'
			.'<label class="col-sm-2 control-label" for="input-or'.$no_of_tab.'"><input '.(($method_data['product_or']=='1')?'checked="checked"':'').' type="checkbox" name="xshippingpro[product_or]" value="1" id="input-or'.$no_of_tab.'" /></label>'
			.'<div class="col-sm-10"><label style="text-align:left;" class="control-label" for="input-or'.$no_of_tab.'"><span data-toggle="tooltip" title="'.$data['text_or_mode_tip'].'">'.$data['text_or_mode'].'</span></label></div>'
			.'</div>'
			.'</div>'
			.'<div class="tab-pane" id="price_'.$no_of_tab.'">'
			.'<div class="form-group range-option" '.(($method_data['rate_type']!='flat')?'style="display:block"':'').'>'
			.'<label class="col-sm-2 control-label" for="input-method-specific'.$no_of_tab.'"><input '.(($method_data['method_specific']=='1')?'checked="checked"':'').' type="checkbox" name="xshippingpro[method_specific]" value="1" id="input-method-specific'.$no_of_tab.'" /></label>'
			.'<div class="col-sm-10"><label style="text-align:left;" class="control-label" for="input-method-specific'.$no_of_tab.'">'.$data['text_method_specific'].'</label></div>'
			.'</div>'
			.'<div class="form-group">'
			...
			.'</select></div>'
			.'</div>'
			.'<div class="form-group dimensional-option" '.(($method_data['rate_type']=='dimensional' || $method_data['rate_type']=='volumetric')?'style="display:block"':'style="display:none"').'>'
			.'<label class="col-sm-2 control-label" for="input-dimension_factor'.$no_of_tab.'">'.$data['text_dimensional_factor'].'</label>'
			...
			.'</div>'
			.'<div class="form-group">'
			.'<label class="col-sm-2 control-label" for="input-mask'.$no_of_tab.'"><span data-toggle="tooltip" title="'.$data['text_mask_price'].'">'.$data['text_mask_title'].'</span></label>'
			...
			.'</div>'
			.'<div class="form-group range-option" '.(($method_data['rate_type']!='flat')?'style="display:block"':'').'>'
			.'<label class="col-sm-2 control-label" for="input-cart-modifier'.$no_of_tab.'"><span data-toggle="tooltip" title="'.$data['tip_cart_value'].'">'.$data['text_cart_value'].'</span></label>'
			.'<div class="col-sm-10"><input id="input-cart-modifier'.$no_of_tab.'" class="form-control" type="text" name="xshippingpro[cart_adjust]" value="'.$method_data['cart_adjust'].'" /></div>'
			.'</div>'
			.'<div class="form-group range-option" '.(($method_data['rate_type']!='flat')?'style="display:block"':'').'>'
			...
			.'</div>'
			.'<div class="form-group">'
			.'<label class="col-sm-2 control-label" for="input-method'.$no_of_tab.'">'.$data['text_hide'].'</label>'
			...
			$return.='</div>'
			   ...
			   .'</div>'
			.'<div class="form-group">'
			.'<label class="col-sm-2 control-label" for="input-method-inactive'.$no_of_tab.'">'.$data['text_hide_inactive'].'</label>'
			.'<div class="col-sm-10"><input type="text" value="" placeholder="'.$data['text_hide_placeholder'].'" id="input-method-inactive'.$no_of_tab.'" class="form-control hide-shipping hide-inactive" />'
			.'<div class="well well-sm hide-methods-inactive" style="height: 150px; overflow: auto;">';
			foreach ($method_data['hide_inactive'] as $hide_tab_id) {
				if (isset($data['methods'][$hide_tab_id])) {
					$return.='<div class="hide-method-inactive'.$hide_tab_id. '"><i class="fa fa-minus-circle"></i> '.$data['methods'][$hide_tab_id].'<input type="hidden" name="xshippingpro[hide_inactive][]" value="'.$hide_tab_id.'" /></div>';
				}
			}
			$return.='</div>'
			   .'</div>'
