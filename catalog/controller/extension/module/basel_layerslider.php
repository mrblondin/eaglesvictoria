...
class ControllerExtensionModuleBaselLayerslider extends Controller {
	public function index($setting) {
		...
		/*$scriptLink = '<script defer type="text/javascript"  src="catalog/view/theme/basel/js/masterslider.js" />' ."\n";
		$document = JFactory::getDocument();
		$document->addCustomTag($scriptLink);*/
		$this->document->addScript('catalog/view/theme/basel/js/masterslider.js', 'header', true, false);
