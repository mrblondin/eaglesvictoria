...
class ControllerAccountPartialOrders extends Controller
{
    public function index()
    {
        ...
        $data['text_partial_empty'] = $this->language->get('text_partial_empty');

        $data['orders'] = array();

        $this->load->model('account/order');

        $order_total = $this->model_account_order->getTotalPartialOrders();

        $results = $this->model_account_order->getPartialOrders(($page - 1) * 10, 10);
        ...
        $this->response->setOutput($this->load->view('account/partial_orders', $data));
    }
