...
class ControllerAccountReturn extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $mail->setSubject(html_entity_decode(sprintf('Return of the Item, Order ID:' . $this->request->post['order_id'] . ', Model: ' . $this->request->post['model'], $this->config->get('config_name')), ENT_QUOTES, 'UTF-8'));
