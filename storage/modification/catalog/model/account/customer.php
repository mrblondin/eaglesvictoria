...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$data['custverfmodule'] = (substr(VERSION,0,3) >='3.0' || substr(VERSION,0,3) =='2.3') ? $this->load->controller('extension/module/custverf', $customer_id) : $this->load->controller('module/custverf', $customer_id);
			return $customer_id;
	}
