...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		$this->load->language('account/login');
            ...
            $data['login_warning'] = $this->language->get('login_warning');
            $data['partial_payment_total'] = isset($this->session->data['partial_payment_total']) ? $this->session->data['partial_payment_total'] : '';
