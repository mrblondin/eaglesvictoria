...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->setText($this->request->post['enquiry'] . "\n\nThis message was sent using the contact form of Eagles Victoria web site");
			$mail->send();
	...
	public function success() {
		...
		$data['footer'] = $this->load->controller('common/footer');
		$data['header'] = $this->load->controller('common/header');
        $data['text_message'] = "You message was successfully sent!<br/><br/>phone:+358 40 594 64 66<br/>(Mon — Fri, 10:00 — 17:00)
e-mail:info@eaglesvictoria.com";
